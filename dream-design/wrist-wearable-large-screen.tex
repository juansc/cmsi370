...
The screen is one, large continuous screen, although only one section of the screen will be active at any given time. With the use of gyroscopes and accelerometers, the device is able to detect its orientation and active the third of the screen that is most appropriate. The screen is divided into three sections: the main screen, the secondary screen, and the notifications screen. The main screen appears on the top of the users forearm, on the same side most people wear their watches. The secondary screen is found on the bottom part of the forearm and will be visible whenever the users palm is oriented towards the user's face. The notification screen will be on the interior of the user's forearm, placed between the main and secondary screen. 

\subsubsection{Main and Secondary Screens}
Most users are used to looking at the top of their forearm when interacting with wrist-worn devices such as watches or fitness trackers. As such, the main screen is where the user will spend most of their time interacting with the device. The main screen only has a \textbf{horizontal orientation}, since physically it would be uncomfortable to hold the device vertically and look at the screen at the same time. The device has the traditional mental model of a menu interface that exists in tablets and smartphones. The main screen as well as the secondary screen have on-screen buttons which have a Back button, Home Button, and Search Button. When it came time to choose between capacitive and on-screen buttons, the design choice became on-screen for two reasons. One, since the the device two large screens, each one would need a set of capacitive buttons which would complicate the design. Two, capacitive buttons are always on, which make users prone to accidentally hitting the buttons when viewing videos or pressing buttons which are very close to the capacitive buttons. On-screen buttons, on the other hand, can be customized by users and positioned wherever the user chooses. The default position of these buttons will be on the right-hand side of the screen, where they are most accessible to the user. 

The other screen where users will spend long periods of time interacting with the device is the secondary screen. The secondary screen allows users to use the camera to take pictures of themselves or participate in video chats. The secondary screen  
